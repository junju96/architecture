...
//                        + " is different than previous " + mJobId);
    ...
    static final class CompatWorkEnqueuer extends WorkEnqueuer {
        ...
        void enqueueWork(Intent work) {
            try {
                ...
                d(TAG, "Starting service for work: " + work);
    ...
    final class CommandProcessor extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            d(TAG, "Starting to dequeue work...");

            while ((work = dequeueWork()) != null) {
                d(TAG, "Processing next work: " + work);
                onHandleWork(work.getIntent());
                d(TAG, "Completing work: " + work);
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    ...
                    work.complete();
                    d(TAG, "should complete the cache service, wait time:" + waitTime);
                }
            }

            d(TAG, "Done processing work!");
    ...
    public int onStartCommand(@Nullable Intent intent, int flags, int startId) {
        if (mCompatQueue != null && mCompatWorkEnqueuer != null) {
            ...
            d(TAG, "Received compat start command #" + startId + ": " + intent);
            ...
            d(TAG, "Ignoring start command: " + intent);
    ...
    void ensureProcessorRunningLocked(boolean reportStarted) {
        if (mCurProcessor == null) {
            ...
            d(TAG, "Starting processor: " + mCurProcessor);
